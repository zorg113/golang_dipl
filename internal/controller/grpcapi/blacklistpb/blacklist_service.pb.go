...
var file_blacklist_service_proto_rawDesc = string([]byte{
...
var (
	...
	file_blacklist_service_proto_rawDescData []byte
)

func file_blacklist_service_proto_rawDescGZIP() []byte {
	file_blacklist_service_proto_rawDescOnce.Do(func() {
		file_blacklist_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_blacklist_service_proto_rawDesc), len(file_blacklist_service_proto_rawDesc)))
	})
	return file_blacklist_service_proto_rawDescData
}

var file_blacklist_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_blacklist_service_proto_goTypes = []any{
...
func file_blacklist_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_blacklist_service_proto_rawDesc), len(file_blacklist_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
