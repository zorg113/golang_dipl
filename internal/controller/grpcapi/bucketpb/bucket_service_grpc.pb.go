...
const (
	Bucket_ResetBucket_FullMethodName = "/bucket.Bucket/ResetBucket"
)
...
func (c *bucketClient) ResetBucket(ctx context.Context, in *ResetBucketRequest, opts ...grpc.CallOption) (*ResetBucketResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResetBucketResponse)
	err := c.cc.Invoke(ctx, Bucket_ResetBucket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBucketServer) ResetBucket(context.Context, *ResetBucketRequest) (*ResetBucketResponse, error) {
...
func RegisterBucketServer(s grpc.ServiceRegistrar, srv BucketServer) {
	// If the following call panics, it indicates UnimplementedBucketServer was
...
func _Bucket_ResetBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResetBucketRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BucketServer).ResetBucket(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Bucket_ResetBucket_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BucketServer).ResetBucket(ctx, req.(*ResetBucketRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Bucket_ResetBucket_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "bucket/bucket_service.proto",
}
